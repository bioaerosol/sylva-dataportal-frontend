<template>
  ...
  <div class="alert alert-primary" role="alert"><font-awesome-icon :icon="['fas', 'person-digging']" class="me-2" />Dashboard capabilities are in implementation phase. Stay tuned for updates.</div>
</template>
